...
const FormCompletionInstructions = () => {
  ...
  const handleStartTest = () => {
    if (testData && !isPreparingTest) {
      navigate('/ielts/form-completion/test', { state: { testData } });
    }
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <span className="text-white/80 font-medium">Form Completion</span>
            </nav>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Listen to the recording and complete the form by filling in the missing information.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 mb-8">
            ...
            <div className="space-y-4 text-white/90">
              <div className="flex items-start space-x-3">
                <span className="material-icons text-emerald-400 text-lg mt-1">check_circle</span>
                <p>You will hear a recording once only and answer questions as you listen.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-emerald-400 text-lg mt-1">check_circle</span>
                <p>Listen carefully and fill in the form with the missing information.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-emerald-400 text-lg mt-1">check_circle</span>
            ...
            <div className="text-center">
              {isPreparingTest ? (
                <div className="space-y-4">
                  ...
                  <p className="text-white/70">Please wait while we prepare your form completion test...</p>
                </div>
              ) : error ? (
                <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-white/70">Your form completion test is ready. Click start when you're ready to begin.</p>
                </div>
              )}
            </div>
          </div>
            ...
            <button
              ...
              className={`inline-flex items-center space-x-3 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform ${
                isPreparingTest || error
                  ...
                  : 'bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white hover:scale-105 shadow-xl hover:shadow-2xl'
              }`}
            >
              {isPreparingTest ? (
                <>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-lg text-white/70 px-6 py-3 rounded-full border border-white/20">
              <span className="material-icons text-emerald-400">schedule</span>
...
export default FormCompletionInstructions; 