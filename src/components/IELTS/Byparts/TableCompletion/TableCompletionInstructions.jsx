...
const TableCompletionInstructions = () => {
  ...
  const handleStartTest = () => {
    if (testData && !isPreparingTest) {
      navigate('/ielts/table-completion/test', { state: { testData } });
    }
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <span className="text-white/80 font-medium">Table Completion</span>
            </nav>
      ...
      <main className="relative z-10 py-8">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-cyan-500 to-cyan-700 rounded-2xl mb-6 shadow-xl">
              <span className="material-icons text-white text-3xl">table_chart</span>
            </div>
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Complete missing information in tables based on the audio content.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 mb-8">
            ...
            <div className="space-y-4 text-white/90">
              <div className="flex items-start space-x-3">
                <span className="material-icons text-cyan-400 mt-1">play_circle</span>
                <p>Listen to the audio recording carefully.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-cyan-400 mt-1">table_chart</span>
                <p>Complete the table by filling in the missing information.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-cyan-400 mt-1">timer</span>
                <p>Write NO MORE THAN THREE WORDS AND/OR A NUMBER for each answer.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-cyan-400 mt-1">check_circle</span>
                <p>Use the exact words you hear in the recording.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-cyan-400 mt-1">spellcheck</span>
                <p>Spelling must be correct for full marks.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 mb-8">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
              <span className="material-icons mr-3 text-cyan-400">quiz</span>
              Test Preparation
            </h2>
            ...
            <div className="text-center">
              <button
                ...
                className={`group px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 ${
                  testData && !isPreparingTest
                    ? 'bg-gradient-to-r from-cyan-500 to-cyan-700 hover:from-cyan-600 hover:to-cyan-800 text-white shadow-xl hover:shadow-2xl transform hover:scale-105'
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
              <span className="material-icons mr-3 text-cyan-400">lightbulb</span>
              Tips for Success
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <span className="material-icons text-cyan-400 mt-1 text-lg">volume_up</span>
                  <div>
                    <h4 className="font-semibold text-white mb-1">Listen for Keywords</h4>
                    <p className="text-white/70 text-sm">Pay attention to key terms that relate to table headers and categories.</p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-3">
                  <span className="material-icons text-cyan-400 mt-1 text-lg">preview</span>
                  <div>
                    <h4 className="font-semibold text-white mb-1">Study the Table</h4>
                    <p className="text-white/70 text-sm">Examine the table structure before listening to understand what information is needed.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <span className="material-icons text-cyan-400 mt-1 text-lg">edit_note</span>
                  <div>
                    <h4 className="font-semibold text-white mb-1">Take Notes</h4>
                    <p className="text-white/70 text-sm">Write down information as you hear it, then transfer to the table.</p>
                  </div>
                </div>
                
                <div className="flex items-start space-x-3">
                  <span className="material-icons text-cyan-400 mt-1 text-lg">format_list_numbered</span>
                  <div>
                    <h4 className="font-semibold text-white mb-1">Follow Order</h4>
                    <p className="text-white/70 text-sm">Information usually follows the order of the table rows.</p>
                  </div>
                </div>
              </div>
            </div>
...
export default TableCompletionInstructions;