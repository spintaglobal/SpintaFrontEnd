...
const MatchingInstructions = () => {
  ...
  const handleStartTest = () => {
    if (testData && !isPreparingTest) {
      navigate('/ielts/matching/test', { state: { testData } });
    }
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <span className="text-white/80 font-medium">Matching</span>
            </nav>
      ...
      <main className="relative z-10 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-700 rounded-2xl mb-6 shadow-xl">
              <span className="material-icons text-white text-3xl">connect_without_contact</span>
            </div>
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Listen to the recording and match the items from different lists based on what you hear.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 mb-8">
            ...
            <div className="space-y-4 text-white/90">
              <div className="flex items-start space-x-3">
                <span className="material-icons text-orange-400 text-lg mt-1">check_circle</span>
                <p>You will hear a recording and need to match items from two different lists.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-orange-400 text-lg mt-1">check_circle</span>
                <p>Read all the options carefully before listening to the audio.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-orange-400 text-lg mt-1">check_circle</span>
                <p>Use the dropdown menus to select the best match for each item.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-orange-400 text-lg mt-1">check_circle</span>
            ...
            <div className="text-center">
              {isPreparingTest ? (
                <div className="space-y-4">
                  ...
                  <p className="text-white/70">Please wait while we prepare your matching test...</p>
                </div>
              ) : error ? (
                <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-white/70">Your matching test is ready. Click start when you're ready to begin.</p>
                </div>
              )}
            </div>
          </div>
            ...
            <button
              ...
              className={`inline-flex items-center space-x-3 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform ${
                isPreparingTest || error
                  ...
                  : 'bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white hover:scale-105 shadow-xl hover:shadow-2xl'
              }`}
            >
              {isPreparingTest ? (
                <>
          ...
          {testData && !isPreparingTest && (
            <div className="text-center">
              <div className="inline-flex items-center space-x-3 mb-6">
                <span className="material-icons text-orange-400">check_circle</span>
