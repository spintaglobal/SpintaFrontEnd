...
const MapLabelingInstructions = () => {
  ...
  const handleStartTest = () => {
    if (testData && !isPreparingTest) {
      navigate('/ielts/map-labeling/test', { state: { testData } });
    }
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <span className="text-white/80 font-medium">Map Labeling</span>
            </nav>
                ...
                {isLoggingOut ? (
                  <>
                    <svg className="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      ...
                      <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 1 8-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
      ...
      <main className="relative z-10 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-lime-500 to-lime-700 rounded-2xl mb-6 shadow-xl">
              <span className="material-icons text-white text-3xl">map</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-black text-white mb-4 leading-tight">
              ...
              <br />
              <span className="text-white/90">Labeling</span>
            </h1>
            <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
              Listen to the recording and label the locations on the map using the correct letters.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/20 mb-8">
            ...
            <div className="space-y-4 text-white/90">
              <div className="flex items-start space-x-3">
                <span className="material-icons text-lime-400 text-lg mt-1">check_circle</span>
                <p>You will see a map with letters (A, B, C, etc.) marking different locations.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-lime-400 text-lg mt-1">check_circle</span>
                <p>Listen to the recording to identify which letter corresponds to each location.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-lime-400 text-lg mt-1">check_circle</span>
                <p>Type the correct letter in the text field next to each location name.</p>
              </div>
              <div className="flex items-start space-x-3">
                <span className="material-icons text-lime-400 text-lg mt-1">check_circle</span>
                <p>Study the map carefully before listening to the audio.</p>
              </div>
              <div className="flex items-start space-x-3">
            ...
            <div className="text-center">
              {isPreparingTest ? (
                <div className="space-y-4">
                  ...
                  <p className="text-white/70">Please wait while we prepare your map labeling test...</p>
                </div>
              ) : error ? (
                <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-white/70">Your map labeling test is ready. Click start when you're ready to begin.</p>
                </div>
              )}
            </div>
          </div>
            ...
            <button
              ...
              className={`inline-flex items-center space-x-3 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform ${
                isPreparingTest || error
                  ...
                  : 'bg-gradient-to-r from-lime-600 to-green-600 hover:from-lime-700 hover:to-green-700 text-white hover:scale-105 shadow-xl hover:shadow-2xl'
              }`}
            >
              {isPreparingTest ? (
                <>
          ...
          <div className="mt-12 text-center">
            <div className="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-lg text-white/70 px-6 py-3 rounded-full border border-white/20">
              <span className="material-icons text-lime-400">schedule</span>
              <span className="font-medium">Estimated time: 5-8 minutes</span>
            </div>
          </div>
          ...
          {testData && !isPreparingTest && (
            <div className="text-center">
              <div className="inline-flex items-center space-x-3 mb-6">
                <span className="material-icons text-lime-400">check_circle</span>
...
export default MapLabelingInstructions; 