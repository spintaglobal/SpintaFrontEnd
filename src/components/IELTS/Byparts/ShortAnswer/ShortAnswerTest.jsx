...
const ShortAnswerTest = () => {
  ...
  const handleNewTest = async () => {
    ...
    try {
      ...
      const newTestCode = `E-T${randomTestNumber}`;
      ...
      navigate('/ielts/short-answer/test', { 
        state: { 
          testData: {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <span className="text-white/80 font-medium">Short Answer Test</span>
            </nav>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 shadow-xl border border-white/20 mb-8">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Listen to the recording and answer the questions below</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                <button
                  ...
                  className="flex items-center justify-center w-12 h-12 bg-pink-600 hover:bg-pink-700 rounded-full transition-colors duration-300"
                >
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border-2 text-lg transition-all duration-300 ${
                        isSubmitted
                          ...
                          : 'bg-white/90 border-white/30 text-gray-800 focus:border-pink-500 focus:bg-white'
                      }`}
              ...
              <div className="text-center">
                ...
                <div className="flex justify-center space-x-4">
                  <button
                    ...
                    className="bg-pink-600 hover:bg-pink-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-6 py-3 rounded-xl font-semibold transition-colors duration-300 flex items-center space-x-2"
                  >
                    {isLoadingNewTest ? (
                      <>
                        <svg className="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          {!isSubmitted && (
            <div className="text-center">
              <button
                ...
                className="bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
              >
                Submit Answers
              </button>
            </div>
